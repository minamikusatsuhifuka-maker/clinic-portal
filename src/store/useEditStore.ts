...
const DEFAULT_MANUALS: ManualItem[] = [
  ...
  { id: "9", icon: "🏥", title: "CarePortal かんたん使い方マニュアル（新人スタッフ向け）", desc: "入職初日から使えるCarePortalガイド", tag: "通常", content: "# CarePortal かんたん使い方マニュアル\n**対象：新人スタッフ（入職初日から使えます）**\n\n## CarePortalって何？\n\n南草津皮フ科のスタッフ専用アプリです。仕事に必要なことが全部ここに集まっています。\n\n- 📋 業務マニュアルを見る\n- ✅ 今日やることを確認する\n- 🤖 AIに相談する\n- 📈 自分の成長を記録する\n\nスマホでもパソコンでも使えます。\n\n## ログイン方法\n\n1. ブラウザで https://clinic-portal-tau.vercel.app を開く\n2. 「スタッフとしてログイン」ボタンをクリック\n\n## 毎日使う機能 TOP5\n\n### ① ダッシュボード（トップ画面）\n今日やることが一目でわかります。毎朝出勤したらまずここを確認してください。\n- 今日のチェックリスト\n- 対応が必要なリスク案件\n- 院長からの今日のメッセージ\n\n### ② 業務マニュアル\n「どうするんだっけ？」と迷ったらここ。受付・会計・電話対応などの手順が全て載っています。\n\n### ③ Air（AIアシスタント）\n画面右下の🤖アイコンをクリックするといつでも話しかけられます。\n「患者さんへの説明はどうすればいい？」「クレーム対応のコツは？」など何でも聞けます。\n\n### ④ ヒヤリハット共有\nミスしそうになったことを匿名で報告できます。チーム全体で共有して同じミスを防ぎます。\n\n### ⑤ 役職ガイド\n自分の職種が「何をすべきか」を確認できます。診療補助・血液検査のガイドラインも確認できます。\n\n## 成長を記録する機能\n\n### 📋 OJTチェックリスト\n入職後の成長を3段階で確認できます。\n- 🌱 3ヶ月：基本業務・理念の理解\n- 🌿 6ヶ月：一人立ち・チームサポート\n- 🌳 12ヶ月：後輩指導・改善提案\n\n### 🗺️ スキルマップ\n自分のスキルをレーダーチャートで確認できます。Airが「次に伸ばすべきポイント」をアドバイスしてくれます。\n\n### 🎯 個人目標MBO\n四半期（3ヶ月）ごとに目標を設定できます。Airに目標案を提案してもらうこともできます。\n\n### 🚀 キャリアパス設計\n「3年後にどんなスタッフになりたいか」を入力するとAirがロードマップを作ってくれます。\n\n## 練習・学習の機能\n\n### 🎭 AIロールプレイ\nAirが「患者さん役」になって接客練習ができます。初診受付・会計説明・クレーム対応の3シナリオあります。\n\n### 📝 知識確認テスト\nマニュアルや理念の内容からAIがクイズを自動作成します。4択形式で気軽に挑戦できます。\n\n## チームと関わる機能\n\n### 📊 エンゲージメントサーベイ\n毎月5問の匿名アンケートです（1〜2分）。チームの状態把握に使われます。\n\n### 🏆 MVP表彰\n毎月「頑張っていたスタッフ」を匿名で推薦できます。毎月1日に発表されます。\n\n## 困ったときは\n\n1. まずAir（AIアシスタント）に相談\n2. 次に業務マニュアルを確認\n3. それでも解決しなければ先輩・マネージャーに相談\n\n**CarePortalはあなたの成長をサポートするツールです。毎日少しずつ使って、自分のペースで成長していきましょう！🌸**" },
]
  ...
  persist(
    ...
    }),
    {
      ...
      migrate: (persistedState: unknown, version: number) => {
        ...
        if (version === 0) {
          const manuals = (state.manuals || []) as ManualItem[]
          if (!manuals.find(m => m.id === "9")) {
            const newManual = DEFAULT_MANUALS.find(m => m.id === "9")
            if (newManual) {
              state.manuals = [...manuals, newManual]
            }
          }
        }
        return state as unknown as EditStore
      },
    }
  )
)
